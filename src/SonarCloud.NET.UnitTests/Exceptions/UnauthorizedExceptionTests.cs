...
public class UnauthorizedExceptionTests
{
  ...
  {
    // Arrange & Act
    var ex = new UnauthorizedException("Custom exception message");
  ...
  public void Constructor_StringAndException_Exception()
  {
    ...
    // Act
    var ex = new UnauthorizedException("Custom exception message", innerException);
  ...
  public void Constructor_Exception_Exception()
  {
    ...
    // Act
    var ex = new UnauthorizedException(innerException);
